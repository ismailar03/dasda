...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
        <h1 class="text-2xl font-semibold text-center mb-6">Login dulu Minimal Lik</h1>
        ...
        <form action="{{ route('auth.login') }}" method="POST">
            ...
            <button type="submit" class="w-full bg-blue-500 text-white font-semibold py-2 rounded-md hover:bg-blue-600 transition">Login</button>
        </form>

        <p class="mt-4 text-center">Wis due akun belum likkk? <a href="{{ route('auth.register') }}" class="text-blue-500 hover:underline">Bikin disiniiiiii kaka</a></p>
    </div>
</body>
</html>
